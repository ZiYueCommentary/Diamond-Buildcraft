...
public class WallBase extends BlockBase{
    ...
    public WallBase(String name, Material material, float hardness, float resistance, SoundType soundType, int lightValue)
    {
        super(name, material);
