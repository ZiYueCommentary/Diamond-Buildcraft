...
{
    public BlockDoubleSlabBase(String name, Material material, CreativeTabs tab, BlockSlab half) //无亮度情况
    {
    ...
    public BlockDoubleSlabBase(String name, Material material, CreativeTabs tab, BlockSlab half, float lightValue) //有亮度情况
    {
        super(name, material, half);
        setCreativeTab(tab);
        setHardness(4.0F);
