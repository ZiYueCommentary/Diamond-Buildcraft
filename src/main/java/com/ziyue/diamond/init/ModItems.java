...
import com.ziyue.diamond.objects.items.SwordBase;
...
public class ModItems extends Item {
    ...
    public static final ToolMaterial MATERIAL_DRY_DIAMOND = EnumHelper.addToolMaterial("material_dry_diamond", 0, 32, 8.0F, 2.5F, 10);
    ...
    //干钻石剑
    public static final Item DRY_DIAMOND_SWORD = new SwordBase("dry_diamond_sword", MATERIAL_DRY_DIAMOND);
